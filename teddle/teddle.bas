!--------------------------------------------------
!- Tuesday, February 21, 2023 2:52:41 PM
!- Import of : 
!- c:\dev\c=ordle\teddle\teddle.prg
...
840 :
850 gu=gu+1
860 if w$=g$ then print p$;"{green}you win!":goto 890
870 if gu>6 then print p$;"{red}you failed. the word was: {black}";w$:goto 890
880 goto530
